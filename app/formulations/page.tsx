...
const BreadcrumbsUrls = [
  ...
  { title: "Formulations",    url: "/formulations"    },
];

const FormulationPageSchema = {
  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(FormulationPageSchema) }}
      />

      <BannerCommon
        BreadcrumbsUrls={BreadcrumbsUrls}
        BreadcrumbsCurrent="Formulations"
        BannerImg="resources/Formulations-banner.png"
        BannerHeading="Formulations"
        ...
        <Box sx={{ p: 4, alignItems: "center", background: "#fff", borderRadius: "20px" }}>
          ...
          <Box display="flex" justifyContent="space-around" alignItems="center" pt="20px">
            <Box width="100%" maxWidth={981} display="flex" flexDirection="column" alignItems="center" gap={1}>
              ...
              >
                 Soon We Will Publish Formulations Books
              </Typography>
              ...
              >
                {`We are under process of writing and publishing the formulation book,
